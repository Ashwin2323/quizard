 ...
 const userId = params.userId;
  return (
    <div className="flex">
      ...
      {/* Desktop Sidebar */}
      <div className="hidden bg-gray-950 text-white lg:block w-[250px] sm:w-[250px] space-y-8 border-r border-gray-800 dark:border-gray-700 p-12 px-5 sticky top-0 h-screen border-t">
